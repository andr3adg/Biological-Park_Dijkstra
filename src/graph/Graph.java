...
public interface Graph<V, E> {
    ...
    /**
     * Returns a vertex's ascendent edges as an iterable collection.
     * @param v vertex
     * @return set of vertices
     */
    public Iterable<Edge<E, V>> ascendentEdges(Vertex<V> v)
            throws InvalidEdgeException;
    ...
    /**
     * Retorna aresta composta pelos dois vertices
     * @param verticeA vertexA
     * @param verticeB vertexB
     * @return aresta composta pelos dois vertices
     */
